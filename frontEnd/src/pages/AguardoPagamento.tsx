...
const AguardoPagamento: React.FC = () => {
  ...
  const getStatusMessage = () => {
    ...
    if (tentativas > maxTentativas) return 'O tempo de verificação excedeu. Por favor, verifique seus pedidos ou entre em contato conosco.';
          ...
          {tentativas > maxTentativas && pedidoStatus?.status !== 'pago' && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-6">
              <p className="text-yellow-800 text-sm">
                Se você já realizou o pagamento, não se preocupe. Ele será processado. 
                Você pode verificar o status mais tarde na página "Meus Pedidos".
              </p>
            </div>
          )}
