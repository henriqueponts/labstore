...
const RegisterPage: React.FC = () => {
  ...
  const { register, isLoading } = useAuth(); // A função 'register' do contexto já usa 'registrar' do apiService
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const registeredUser = await register({ // Chama context.register
        nome,
        email,
        senha: password,
      ...
      setError(err.message || 'Ocorreu um erro durante o registro. Tente novamente.');
      console.error(err);
    }
  };
